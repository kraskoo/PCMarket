    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            this.CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AdminUsers", t => t.AuthorId, true)
                .Index(t => t.AuthorId);
        ...
        public override void Down()
        {
            ...
            this.DropForeignKey("dbo.VideoCards", "Id", "dbo.Companies");
            this.DropForeignKey("dbo.VideoCards", "CompanyId", "dbo.Companies");
            this.DropForeignKey("dbo.UsbFlashes", "Id", "dbo.Companies");
            this.DropForeignKey("dbo.UsbFlashes", "CompanyId", "dbo.Companies");
            this.DropForeignKey("dbo.SolidStateDrives", "Id", "dbo.Companies");
            this.DropForeignKey("dbo.SolidStateDrives", "CompanyId", "dbo.Companies");
            this.DropForeignKey("dbo.Processors", "Id", "dbo.Companies");
            this.DropForeignKey("dbo.Processors", "CompanyId", "dbo.Companies");
            this.DropForeignKey("dbo.Motherboards", "Id", "dbo.Companies");
            this.DropForeignKey("dbo.Motherboards", "CompanyId", "dbo.Companies");
            this.DropForeignKey("dbo.HardDrives", "Id", "dbo.Companies");
            this.DropForeignKey("dbo.HardDrives", "CompanyId", "dbo.Companies");
            this.DropForeignKey("dbo.BackupDevices", "Id", "dbo.Companies");
            ...
            this.DropIndex("dbo.VideoCards", new[] { "Id" });
            this.DropIndex("dbo.UsbFlashes", new[] { "CompanyId" });
            this.DropIndex("dbo.UsbFlashes", new[] { "Id" });
            this.DropIndex("dbo.SolidStateDrives", new[] { "CompanyId" });
            this.DropIndex("dbo.SolidStateDrives", new[] { "Id" });
            this.DropIndex("dbo.Processors", new[] { "CompanyId" });
            this.DropIndex("dbo.Processors", new[] { "Id" });
            this.DropIndex("dbo.Motherboards", new[] { "CompanyId" });
            this.DropIndex("dbo.Motherboards", new[] { "Id" });
            this.DropIndex("dbo.HardDrives", new[] { "CompanyId" });
            this.DropIndex("dbo.HardDrives", new[] { "Id" });
            this.DropIndex("dbo.BackupDevices", new[] { "CompanyId" });
            this.DropIndex("dbo.BackupDevices", new[] { "Id" });
